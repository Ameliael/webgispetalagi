...
lyr_GoogleSatellite_0.setVisible(true);lyr_batasadministrasi_1.setVisible(true);lyr_jalan1_2.setVisible(true);lyr_titik_3.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_batasadministrasi_1,lyr_jalan1_2,lyr_titik_3];
...
lyr_batasadministrasi_1.set('fieldLabels', {'KDPPUM': 'no label', 'NAMOBJ': 'inline label', 'REMARK': 'no label', 'KDPBPS': 'no label', 'FCODE': 'no label', 'LUASWH': 'no label', 'UUPP': 'no label', 'SRS_ID': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'KDEBPS': 'no label', 'KDEPUM': 'no label', 'KDCBPS': 'no label', 'KDCPUM': 'no label', 'KDBBPS': 'no label', 'KDBPUM': 'no label', 'WADMKD': 'no label', 'WIADKD': 'no label', 'WADMKC': 'inline label', 'WIADKC': 'no label', 'WADMKK': 'no label', 'WIADKK': 'no label', 'WADMPR': 'no label', 'WIADPR': 'no label', 'TIPADM': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_jalan1_2.set('fieldLabels', {'id': 'no label', 'JALAN': 'inline label', });
lyr_titik_3.set('fieldLabels', {'Name': 'inline label', 'descriptio': 'no label', 'timestamp': 'no label', 'pdfmaps_ph': 'no label', 'Photo Name': 'no label', 'Photo Date': 'no label', 'Photo Time': 'no label', 'Photo Loca': 'no label', 'Photo Orie': 'no label', 'Device Typ': 'no label', 'NAMOBJ': 'no label', 'REMARK': 'no label', 'LUASWH': 'no label', 'LCODE': 'no label', 'METADATA': 'no label', 'WADMKD': 'inline label', 'WADMKC': 'inline label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', 'Titik': 'no label', 'Foto': 'no label', 'Luas_Ha': 'no label', 'layer': 'no label', 'path': 'no label', });
